# Generated by Django 4.1.7 on 2023-03-27 09:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, to='baykeshop.baykeshoporderinfo', verbose_name='订单')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', baykeshop.public.tinymce.TinymceField(tinymce={'plugins': ['advlist', 'autolink', 'link', 'image', 'lists', 'charmap', 'preview', 'anchor', 'pagebreak', 'searchreplace', 'wordcount', 'visualblocks', 'visualchars', 'code', 'fullscreen', 'insertdatetime', 'media', 'table', 'emoticons', 'template', 'help'], 'toolbar': 'undo redo | styles | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image | print preview media | forecolor backcolor emoticons'}, verbose_name='内容')),
